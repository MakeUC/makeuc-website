  ...
  return (
    ...
    >
      <CheckboxPrimitive.Root
        ref={ref}
        className={cn(
          "peer flex h-6 w-6 shrink-0 rounded-sm push-in-top push-in-bottom bg-background-inset disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bump-out data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground",
          className,
        )}
