...
export const hackerScheduleData: ScheduleData[] = [
...
export const workshopScheduleData: ScheduleData[] = [
...
//     <>
//       <div>
//         <PageTitle className={"mb-10 overflow-hidden whitespace-nowrap font-mono animate-typewriter-blinking-cursor-${headerLength}"}>
//           Day Of Schedules
