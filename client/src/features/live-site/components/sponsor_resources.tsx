    ...
    <div className="grid grid-cols-1 gap-8">
      <Accordion type="multiple" className="w-full">
        ...
        <AccordionItem value="MLH">
          ...
          <AccordionContent className="border-b border-muted-foreground">
            <Link className="underline text-primary" href={"https://hack.mlh.io/software"}>MLH Free Software Access</Link>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="XYZ">
          ...
          <AccordionContent className="border-b border-muted-foreground">
            ...
            <br />
            <Link className="underline text-primary" href={"https://drive.google.com/file/d/1vGsKOSeREApAiggHSDr22AtHn6-P_q0w/view?usp=sharing"}>.XYZ Domain Usage Guide</Link>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="Kinetic Vision">
          ...
          <AccordionContent className="border-b border-muted-foreground">
            <Link className="underline text-primary" href={"https://drive.google.com/file/d/1VFs8eyWfBLTm3hR_FIzfV2V9byeIScNp/view?usp=sharing"}>Kinetic Vision's Most Innovative Use of IoT Data Challenge</Link>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
