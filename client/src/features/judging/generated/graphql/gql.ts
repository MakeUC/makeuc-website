 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetProjects($where: ProjectWhereInput! = {}, $skip: Int! = 0, $take: Int = 20, $orderBy: [ProjectOrderByInput!]! = [], $cursor: ProjectWhereUniqueInput) {\n  projects(\n    where: $where\n    skip: $skip\n    take: $take\n    orderBy: $orderBy\n    cursor: $cursor\n  ) {\n    id\n    url\n    name\n    countJudgements\n    judgingGroup\n    year\n    score\n    disqualified\n  }\n  projectsCount(where: $where)\n}"): (typeof documents)["query GetProjects($where: ProjectWhereInput! = {}, $skip: Int! = 0, $take: Int = 20, $orderBy: [ProjectOrderByInput!]! = [], $cursor: ProjectWhereUniqueInput) {\n  projects(\n    where: $where\n    skip: $skip\n    take: $take\n    orderBy: $orderBy\n    cursor: $cursor\n  ) {\n    id\n    url\n    name\n    countJudgements\n    judgingGroup\n    year\n    score\n    disqualified\n  }\n  projectsCount(where: $where)\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
