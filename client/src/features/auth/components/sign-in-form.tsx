...
const SUPPORTED_STRATEGIES = {
  google: { name: "Google", iconSrc: GoogleLogo, className: "" },
  microsoft: { name: "Microsoft", iconSrc: MicrosoftLogo, className: "" },
} as const;
    ...
    <div className="flex flex-col gap-2 w-[230px]">
      {
        strategies.map(strategyKey => {
          ...
          return (
            ...
            >
              <Image alt={strategy.name} src={strategy.iconSrc} width={20} height={20} /> Sign in with {strategy.name}
            </Link>
          );
        })
      }
